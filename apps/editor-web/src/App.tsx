...
export function App() {
  ...
  useTranscribePolling(transcribe, setTranscribe);
  useExportPolling(exportState, setExportState, showExportProgressModal, downloadedExportJobs, setDownloadedExportJobs, autoDownloadWhenReady);
